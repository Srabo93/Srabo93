...
<h3 align="center">A ambitious junior Developer</h3>
...
<5 align="left">My Goals for the Front-End:</h5>
<ul>
  <li>get better at REACT, Redux</li>
  <li>gather experiences with UI Libraries</li>
  <li>gather experiences with BaaS like Firebase</li>
  </ul>
<h5 align="left">My Future Goals i want to work towards:</h5>
<ul>
  <li>start developing NODE JS Backend API/Apps</li>
  <li>gather experience with Mongoose and Mongo DB</li>
  <li>develop MERN Stack APP's</li>
  </ul>
  
  <h5 align="left">Experiments I'm planning:</h5>
<ul>
  <li>build a CRM</li>
  <li>build a react native app</li>
  <li>develop a webservice with python</li>
  </ul>
